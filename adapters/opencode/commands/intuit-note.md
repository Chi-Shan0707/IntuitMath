...
Read the command spec below. Use the repository `IntuitMath.skill/SKILL.md` as the skill entry point. If OpenCode stores commands in a different location, copy this Markdown body into that command file unchanged.
