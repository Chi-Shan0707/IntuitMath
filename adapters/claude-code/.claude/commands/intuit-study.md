---
description: Create adaptive study plans, diagnostic reviews, and concept maps for math learning.
argument-hint: <goal, course, or weak topic> [--time 2w|6w|semester] [--level middle|undergrad|grad]
---

Use IntuitMath for this request. Load `IntuitMath.skill/SKILL.md`, then read `IntuitMath.skill/commands/intuit-study.md` as the command contract. User arguments: $ARGUMENTS
